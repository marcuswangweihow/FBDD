...
This folder contains the data and representative results for a workflow with 9N39 using aLMMD (accelerated Ligand-Mapping Molecular Dynamics).

# 4MZI
[⬆️ Back to top](#readme-table-of-contents)

This folder contains the data and representative results for a workflow with 4MZI using aLMMD (accelerated Ligand-Mapping Molecular Dynamics).
...
This folder contains the overview, representative data and results for the fragment processing part of the FBDD workflow.
